...
**SKFET Notification System** — это масштабируемая платформа для оповещения студентов и сотрудников СКФЭТ. Система построена на микросервисной архитектуре с использованием брокера сообщений Kafka и кэширования Redis, что обеспечивает высокую надёжность и производительность.
